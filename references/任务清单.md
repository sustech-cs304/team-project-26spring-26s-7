...
| F3.2 | 实现 LocalImageTagger.ets | `common/ai/LocalImageTagger.ets` | TBD | ⏳ | 高 | 本地图像标签提取 |
| F3.3 | 实现 MetadataAggregator.ets | `common/ai/MetadataAggregator.ets` | TBD | ⏳ | 高 | 旅程元数据聚合 |
| F3.4 | 实现 AiGatewayClient.ets | `common/api/AiGatewayClient.ets` | TBD | ⏳ | 高 | AI 服务 API 客户端 |
...
| ID | 任务 | 文件路径 | 负责人 | 状态 | 优先级 | 说明 |
|----|------|----------|--------|------|--------|------|
| F6.1 | 创建 ai-copy/ 目录 | `feature/ai-copy/` ✅ | TBD | ⏳ | 高 | 新建功能模块 |
| F6.2 | 实现 AiCopyGenerator.ets | `feature/ai-copy/components/AiCopyGenerator.ets` | TBD | ⏳ | 高 | AI 文案生成 UI |
| F6.3 | 实现 AiCopyPage.ets | `feature/ai-copy/views/AiCopyPage.ets` | TBD | ⏳ | 中 | 带风格选择器的页面 |

### F7 - 安全
| ID | 任务 | 文件路径 | 负责人 | 状态 | 优先级 | 说明 |
|----|------|----------|--------|------|--------|------|
| F7.1 | 实现 ExifStripper.ets | `common/security/ExifStripper.ets` | TBD | ⏳ | 高 | 使用 @kit.ImageKit 剥离 EXIF |
| F7.2 | 实现 ShareLinkSigner.ets | `common/security/ShareLinkSigner.ets` | TBD | ⏳ | 高 | 使用 @kit.ArkCrypto 实现 HMAC-SHA256 |
| F7.3 | 实现 LocalStorage.ets | `common/data/LocalStorage.ets` | TBD | ⏳ | 中 | 使用 @kit.ArkData.Preferences |

### F8 - 网络
| ID | 任务 | 文件路径 | 负责人 | 状态 | 优先级 | 说明 |
|----|------|----------|--------|------|--------|------|
| F8.1 | 实现 FileUploader.ets | `common/api/FileUploader.ets` | TBD | ⏳ | 高 | 使用 @ohos.request 上传文件 |
| F8.2 | 实现 SharePortalClient.ets | `common/api/SharePortalClient.ets` | TBD | ⏳ | 中 | 分享链接生成 |

### F9 - 产品层
| ID | 任务 | 文件路径 | 负责人 | 状态 | 优先级 | 说明 |
|----|------|----------|--------|------|--------|------|
| F9.1 | 完善 TravelEditor.ets | `product/entry/src/main/ets/pages/TravelEditor.ets` | TBD | ⏳ | 中 | 节点拖拽排序与编辑 |
| F9.2 | 完善 Index.ets 集成 | `product/entry/src/main/ets/pages/Index.ets` | TBD | ⏳ | 低 | 整合所有功能 |
...
| T2.2 | E2E 测试：生成 AI 文案 | `feature/ai-copy/`, `common/ai/`, `common/api/AiGatewayClient.ets` | TBD | ⏳ | 高 | AI 功能测试 |
