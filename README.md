...
ItsMapPin 是一个基于 HarmonyOS 的旅行记忆应用，帮助用户将照片和地点绑定到地图上，并按旅行线路进行组织，同时支持生成 AI 旅行文案，方便记录与分享旅途中的精彩瞬间。
...
| 地图主页 | 路线详情 |
|---|---|
| ![地图主页](references/media/photos/home-map-view.jpg) | ![路线详情](references/media/photos/route-detail-view.jpg) |

| 节点预览 | 节点详情 |
|---|---|
| ![节点预览](references/media/photos/node-page-view.jpg) | ![节点详情](references/media/photos/node-detail-view.jpg) |

| AI 文案助手 | 社交分享 丨
|---|---|
| ![AI 文案助手](references/media/photos/ai-essay-view.jpg) |![社交分享](references/media/photos/social-share-view.jpg) |
...
进入节点详情页后，点击右上角「编辑」按钮。所有字段均可修改：地点、所属路线、照片、标题、正文、标签、到访日期。
...
3. 选择地点
4. 上传或拍摄照片
5. 输入标题和内容（可以选择添加该节点到一条旅行、标签和用ai辅助生成文案）
6. 点击保存
...
本项目特别感谢 @Xepricorn 作为内部测试员提出的各种软件使用优化建议，这对我们项目的用户体验提升至关重要；
